...
public class UserDaoImpl implements IUserDao {
    ...
    public int deleteByAccount(String account) throws SQLException {
        String sql = "update t_account set isdelete = 1 where useraccount = ?";
    ...
    public User queryByAccount(String account) throws SQLException {
        String sql = "select id, useraccount, username, password, realname, idcode, create_time createTime, modified_time modifiedTime, status, " +
                "isdelete from t_account where useraccount = ? and isdelete != 1";
    ...
    public List<User> queryAll() throws SQLException {
        String sql = "select id, useraccount, username, password, realname, idcode, create_time createTime, modified_time modifiedTime, status, " +
                "isdelete from t_account where isdelete != 1";
        return queryRunner.query(
                sql,
