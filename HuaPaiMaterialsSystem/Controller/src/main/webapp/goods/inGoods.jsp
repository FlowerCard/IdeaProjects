...
<html>
    ...
    <body>
        <div id="box" class="container">
            <!-- 商品类型表单 -->
            <form action="http://localhost/goods/inGoods" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="inNum" id="outNum" required lay-verify="inNum" placeholder="请输入入库数量" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
